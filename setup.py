...
if __name__ == "__main__":
    ...
    setup(
        ...
        install_requires= ['cython', 'ordered-set', 'bidict', 'networkx >= 2.0' , 'tqdm', 'ascii_graph','plotly','scipy==1.0.0','numpy','pandas','fa2','futures;python_version=="2.7"','markov_clustering', 'colorlover'],
